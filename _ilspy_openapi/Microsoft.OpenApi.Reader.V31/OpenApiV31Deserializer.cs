...
/// runtime Open API object model.
/// </summary>
internal static class OpenApiV31Deserializer
{
	...
	{
		(string s) => s.StartsWith("x-", StringComparison.OrdinalIgnoreCase),
		delegate(OpenApiDiscriminator o, string p, ParseNode n, OpenApiDocument doc)
		{
	...
	private static IOpenApiExtension LoadExtension(string name, ParseNode node)
	{
		...
		return value(node.CreateAny(), OpenApiSpecVersion.OpenApi3_1);
	}
