...
/// </summary>
public interface IOpenApiRequestBody : IOpenApiDescribedElement, IOpenApiElement, IOpenApiReadOnlyExtensible, IShallowCopyable<IOpenApiRequestBody>, IOpenApiReferenceable, IOpenApiSerializable
{
	/// <summary>
