...
/// Contact Object.
/// </summary>
public class OpenApiContact : IOpenApiSerializable, IOpenApiElement, IOpenApiExtensible
{
	/// <summary>
	...
	/// <summary>
	/// Serialize <see cref="T:Microsoft.OpenApi.OpenApiContact" /> to Open Api v3.2
	/// </summary>
	...
	private void WriteInternal(IOpenApiWriter writer, OpenApiSpecVersion specVersion)
	{
		...
		writer.WriteProperty("email", Email);
