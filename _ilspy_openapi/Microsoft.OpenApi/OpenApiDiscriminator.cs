...
/// </summary>
public class OpenApiDiscriminator : IOpenApiSerializable, IOpenApiElement, IOpenApiExtensible
{
	/// <summary>
	...
	/// <summary>
	/// Serialize <see cref="T:Microsoft.OpenApi.OpenApiDiscriminator" /> to Open Api v3.2
	/// </summary>
	...
	private void SerializeInternal(IOpenApiWriter writer, OpenApiSpecVersion version)
	{
		...
		writer.WriteProperty("propertyName", PropertyName);
		writer.WriteOptionalMap("mapping", Mapping, delegate(IOpenApiWriter w, OpenApiSchemaReference s)
		{
