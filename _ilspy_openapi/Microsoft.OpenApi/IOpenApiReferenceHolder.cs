...
public interface IOpenApiReferenceHolder<out T, U, V> : IOpenApiReferenceHolder<V>, IOpenApiReferenceHolder, IOpenApiSerializable, IOpenApiElement where T : IOpenApiReferenceable, U where V : BaseOpenApiReference, new()
{
	/// <summary>
...
/// </summary>
/// <typeparam name="V">The type for the reference holding the additional fields and annotations</typeparam>
public interface IOpenApiReferenceHolder<V> : IOpenApiReferenceHolder, IOpenApiSerializable, IOpenApiElement where V : BaseOpenApiReference, new()
{
	/// <summary>
	/// Reference object.
	/// </summary>
...
/// A generic interface for OpenApiReferenceable objects that have a target.
/// </summary>
public interface IOpenApiReferenceHolder : IOpenApiSerializable, IOpenApiElement
{
	/// <summary>
