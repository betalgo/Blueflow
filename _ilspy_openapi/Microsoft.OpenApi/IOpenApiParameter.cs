...
/// </summary>
public interface IOpenApiParameter : IOpenApiDescribedElement, IOpenApiElement, IOpenApiReadOnlyExtensible, IShallowCopyable<IOpenApiParameter>, IOpenApiReferenceable, IOpenApiSerializable
{
	/// <summary>
