...
internal class AnyMapFieldMapParameter<T, U>
{
	...
	/// Constructor
	/// </summary>
	public AnyMapFieldMapParameter(Func<T, IDictionary<string, U>?> propertyMapGetter, Func<U, JsonNode?> propertyGetter, Action<U, JsonNode> propertySetter, Func<T, IOpenApiSchema?> schemaGetter)
	{
